...
const TITLE = "How to Use StreamFlix: From First Launch to Fluent";
const DESCRIPTION =
  "Set up providers, switch servers when a stream stalls, load and style subtitles, pick audio tracks, build a watchlist, and use resume properly in both StreamFlix apps.";
