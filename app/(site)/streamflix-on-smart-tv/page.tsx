...
const TITLE = "StreamFlix on Smart TV: Samsung, LG, Casting and Sticks";
const DESCRIPTION =
  "Samsung Tizen and LG webOS cannot run an APK. How to cast StreamFlix from a phone, when a streaming stick is the better answer, and which TVs can install it directly.";
