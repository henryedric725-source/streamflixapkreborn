...
const TITLE = "How to Update StreamFlix Without Losing Your Data";
const DESCRIPTION =
  "Overlay installs, the in-app updater, signature mismatches, and when staying on an older build is the better decision. Update StreamFlix without losing favourites or downloads.";
