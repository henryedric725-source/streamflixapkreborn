...
const TITLE = "Is StreamFlix Legal? Aggregators, Hosting and the DMCA";
const DESCRIPTION =
  "Why the original StreamFlix was taken down, the legal difference between hosting and aggregating, how streaming law varies by country, and where the risk actually sits.";
